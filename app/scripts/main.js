function relation(data, canvas) {
  var a = data.node, b = data.link, force, d = canvas, e, f = 'id', g = 12, h = 800, i = 600,
    l = 2;
  this.init = function () {
  ...
  this.render = function () {
    e.clearRect(0, 0, h, i);
      ...
      a.forEach(function (a) {
        e.fillStyle = '#A142FF',
          e.beginPath(),
          e.arc(a.x, a.y, a.radius||10, 0, 2 * Math.PI),
          e.fill(),
          e.stroke()
      }),
      e.font = '12px',
  ...
  this.initDrag = function () {
    ...
    d3.select(d).call(d3.drag().container(d).subject(a).on('start', start).on('drag', drag).on('end', end))
  };
...
function initRelationShip() {
  ...
  var data = {
    node: [
      ...
      {'id': '4', 'name': 'Network'}, {'id': '5', 'name': 'Aaron'}, {'id': '6', 'name': 'Abbott'}, {
        'id': '7',
        'name': 'Jacob'
      }, {'id': '8', 'name': 'James'},
      {'id': '9', 'name': 'Kelvin'}, {'id': '10', 'name': 'Kendall'}, {'id': '11', 'name': 'Kendrickw'}, {
        'id': '12',
        'name': 'Leroy'
      }, {'id': '13', 'name': 'Leslie'},
